...
class RRDB(nn.Module):
    ...
    def __init__(self, nf, gc=32):
        ...
        self.conv1 = nn.Conv2d(nf*3,nf,3,1,1,bias=True)
        self.ca = CALayer(nf)
        mutil.initialize_weights([self.conv1,self.ca],0.1)
...
class CALayer(nn.Module):
    def __init__(self, channel, reduction=16):
        ...
        self.avg_pool = nn.AdaptiveAvgPool2d(48)
        self.max_pool = nn.AdaptiveMaxPool2d(48)
